...
public final class SwtBotProjectActions {
  ...
  public static void createUiBinder(final SWTEclipseBot bot,
  ...
  public static void createWebAppProject(final SWTEclipseBot bot,
  ...
  public static void deleteProject(final SWTEclipseBot bot,
   ...
   * view is visible.
   */
  public static void openProjectProperties(final SWTEclipseBot bot,
      String projectName) {
  ...
  public static SWTBotTreeItem selectProject(final SWTEclipseBot bot,
      String projectName) {
    /*
