...
/**
 * Shows a dialog with instructions for E34.
 */
public class UpdateDetailsPresenter implements IUpdateDetailsPresenter {
  ...
  public void presentUpdateDetails(Shell shell, String updateSiteUrl, ILog log,
    ...
    MessageDialog.openInformation(
        ...
        "An update is available for the Google Plugin for Eclipse.  Go to \"Help > Update Software\" and then the \"Available Software\" tab.");
  }
}
