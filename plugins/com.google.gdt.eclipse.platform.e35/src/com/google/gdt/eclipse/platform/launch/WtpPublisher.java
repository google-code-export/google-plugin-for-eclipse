...
/**
 * Eclipse 3.5-specific publisher for WTP modules.
 */
  ...
  public static void publishModulesToWarDirectory(IProject project,
      ...
      if (children != null) {
        for (IModule child : children) {
          ...
          if ("jst.utility".equals(child.getModuleType().getId())) {
            ...
            IStatus[] status = helper.publishZip(mr, new Path(
                jarFile.getAbsolutePath()), monitor);
    ...
    if (publishResult.size() > 0) {
      throw new CoreException(new MultiStatus(
          "com.google.gdt.eclipse.platform.e35", 0,
