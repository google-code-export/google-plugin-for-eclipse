...
import @PackageName@.client.MyRequestFactory.MessageRequest;
import @PackageName@.shared.MessageProxy;

public class @ClassName@Widget extends Composite {
  ...
  interface @ClassName@UiBinder extends UiBinder<Widget, @ClassName@Widget> {
  }

  private static @ClassName@UiBinder uiBinder = GWT.create(@ClassName@UiBinder.class);
