...
public class ProjectCreationConstants {
  ...
  public static final String BIN_DIRECTORY = SdkConstants.FD_OUTPUT
      + WS_SEP;
  public static final String LIB_DIRECTORY = SdkConstants.FD_LIB
      + WS_SEP;
  ...
  public static final String[] RES_DIRECTORIES = new String[] {
      DRAWABLE_DIRECTORY, LAYOUT_DIRECTORY, MENU_DIRECTORY, VALUES_DIRECTORY};
  public static final String[] RES_DENSITY_ENABLED_DIRECTORIES = new String[] {
      DRAWABLE_HDPI_DIRECTORY, DRAWABLE_MDPI_DIRECTORY,
      DRAWABLE_LDPI_DIRECTORY, LAYOUT_DIRECTORY, MENU_DIRECTORY,
      VALUES_DIRECTORY};
